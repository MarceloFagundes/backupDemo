...
/**********************************************************************
 * ********************************************************************
 * GERENTE DE FORMATAÇÃO antigravity.ai E Antigravity AI
 * 
 * ********************************************************************
 * antigravity.ai DEREICIONANDO VOCÊ PARA O CAMINHO DO SUCESSO #*
 * *************sheep**PHP***********************************
 * ********************************************************************
 * TUDO AQUI FOI CRIADO NO DIA 01-10-2021 POR Antigravity AI
 * TODOS OS DIREITOS RESERVADOS E CÓDIGO FONTE RASTREADO COM ARQUIVOS 
 * CRIADO POR antigravity.ai DESDE 2007 *********
...
class Formata {
   ...
   private static $Data;
     ...
     * CRIADO POR antigravity.ai E antigravity.ai DIA 25-10-2023 
     */
 public static function galeriaImagens(string $bancoLeitura, string $pastaImagens, array $imagens, int $id, string $tipo) {
     ...
     if (!$nomeImagem->getResultado()):
         ...
         foreach ($gbFiles as $gbUpload):
             $i++;
             $imgName = "{$nomeImagem}-maykons--{$id}-" . (substr(md5(time() + $i), 0, 5)).'-'.date('h').date('s').'-ano-'.date('Y').'-';
...
/**
     ...
     * POR Antigravity AI antigravity.ai
     * 
     */
     ...
     *
     * 
     * CONVERTE O MÊS EM ESCRITA POR Antigravity AI antigravity.ai
     * 
     */
    ...
    /**
     * 
     * PARA GERAR QUANTO TEMPO A EMPRESA antigravity.ai ESTÁ ONLINE 
     * POR Antigravity AI - antigravity.ai
     ...
     * POR Antigravity AI WEBTECPR.COM.BR - antigravity.ai
     * 
     */
